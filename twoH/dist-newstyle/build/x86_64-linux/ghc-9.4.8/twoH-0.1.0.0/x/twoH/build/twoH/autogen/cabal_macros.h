...
/* package twoH-0.1.0.0 */
#ifndef VERSION_twoH
#define VERSION_twoH "0.1.0.0"
#endif /* VERSION_twoH */
#ifndef MIN_VERSION_twoH
#define MIN_VERSION_twoH(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_twoH */
...
#define CURRENT_COMPONENT_ID "twoH-0.1.0.0-inplace-twoH"
